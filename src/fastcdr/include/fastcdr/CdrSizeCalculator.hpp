...
private:
   ...
   */
  template<>
  std::size_t CdrSizeCalculator::calculate_serialized_size [[gnu::weak]] (
							   const int8_t& data,
							   size_t& current_alignment)
  {
    static_cast<void>(data);
   ...
   */
  template<>
  size_t CdrSizeCalculator::calculate_serialized_size [[gnu::weak]] (
   ...
   */
  template<>
  std::size_t CdrSizeCalculator::calculate_array_serialized_size [[gnu::weak]] (
								 const int8_t* data,
								 size_t num_elements,
								 size_t& current_alignment)
  {
