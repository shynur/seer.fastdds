...
private:
   ...
   */
  template<>
  Cdr& Cdr::serialize_array [[gnu::weak]] (
			    const uint8_t* octet_t,
			    size_t num_elements)
  {
   ...
   */
  template<>
  Cdr& Cdr::deserialize_array [[gnu::weak]] (
			      uint8_t* octet_t,
			      size_t num_elements)
  {
   ...
   */
  template<>
  Cdr& Cdr::deserialize_sequence [[gnu::weak]] (
				 std::string*& sequence_t,
				 size_t& num_elements)
  {
